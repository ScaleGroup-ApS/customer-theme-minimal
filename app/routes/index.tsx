        ...
        <div className="grid md:grid-cols-2 gap-20 items-start">
          <FadeUp>
            ...
            <p className="text-[#444444] leading-[1.7] mb-5">
              SYNCRONET ApS er en dansk sportstech-virksomhed med base i København. Vi grundlagde athletos.app med én mission: at give atleter og coaches et professionelt digitalt værktøj, der er intuitivt, hurtigt og datadrevet.
            </p>
          ...
          <div className="space-y-px border border-[#e5e5e5] rounded-lg overflow-hidden">
            {[
              { value: "KBH S", label: "Virksomhedens hjemsted" },
